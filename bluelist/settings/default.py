...
# If you set t his to False, Django will not use timezone-aware datetimes.
USE_TZ = True

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/var/www/example.com/media/"
MEDIA_ROOT = BASE_PATH+'/bluelist/media/'
...
SECRET_KEY = '57p(4$qspmqsko82(pm8&4q-+6!2_5!ly-v@jn%n%ao(-ve)5+'
